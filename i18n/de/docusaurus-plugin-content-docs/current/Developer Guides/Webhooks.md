...
Sie können ein Webhook konfigurieren, um alle Ereignisse zu empfangen, die in Ihrem CRM auftreten.

Beispiele für Webhooks:

<details>

<summary>Deal erstellt</summary>
  ...
  "data": {
    ...
    "changed_attributes": [
      ...
      },
      {
        "name": {
          "previous_value": "",
          "current_value": "Geschäft mit BBBBBBBBBBBBBBBBBBBBB"
        }
      },
      {
        "account_id": {
